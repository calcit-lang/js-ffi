{} (:schema-version 1) (:feature 'standard-host-adapters)
  :doc "|Reusable shared, DOM and Node adapters. Constructors retain host identity; optional lookups normalize nullish values; synchronous effects return Unit and selected async effects return Result."
