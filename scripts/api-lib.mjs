...
export const publicNamespaces = ['js-ffi.browser', 'js-ffi.canvas-batches', 'js-ffi.canvas-scene', 'js-ffi.contract', 'js-ffi.node', 'js-ffi.shared', 'js-ffi.typed-arrays', 'js-ffi.webgpu-batches', 'js-ffi.webgpu-capabilities', 'js-ffi.webgpu'];
...
export function runtimes(namespace) {
  if (namespace === 'js-ffi.browser' || namespace === 'js-ffi.canvas-batches' || namespace === 'js-ffi.canvas-scene' || namespace === 'js-ffi.webgpu' || namespace === 'js-ffi.webgpu-batches' || namespace === 'js-ffi.webgpu-capabilities') return ['browser'];
